...
class MinesweeperAI:
    ...
    def get_neighbors(self, cell):
        ...
        # Iterate over neighboring cells within the bounds
    ...
    def update_safes_and_mines(self):
        # Repeat the update until no changes are made
        counter = 1
        while counter != 0:
            counter = 0

            # Update based on known safes and mines in sentences
            for sentence in self.knowledge:
                for cell in sentence.known_safes():
                    counter += self.mark_safe(cell)
                for cell in sentence.known_mines():
                    counter += self.mark_mine(cell)
            # Update based on known safes and mines in individual cells
    ...
    def get_new_inferences(self):
        ...
        # Iterate over pairs of sentences in knowledge
