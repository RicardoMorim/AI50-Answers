...
def joint_probability(people, one_gene, two_genes, have_trait):
    ...
    for person in people:
        ...
        # If there's no parents data, use the gene probabilities
        if mother is None and father is None:
            ...
            for parent in [mother, father]:
                # Check how many genes each parent will pass
            ...
            # Calculate the probability that the child will get the number of genes
            if genes == 2:
        ...
        # Calculate the probability of trait
